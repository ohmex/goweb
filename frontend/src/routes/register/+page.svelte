	...
	<div class="max-w-md w-full space-y-8">
		<div class="bg-white/90 backdrop-blur-sm py-8 px-6 shadow-xl rounded-xl border border-blue-200">
			<div class="text-center mb-8">
				...
				<p class="text-gray-600">Join us and start creating amazing content</p>
			</div>
			...
			<div class="text-center mt-8">
				<p class="text-gray-600">
					...
					<a href="/login" class="text-primary-600 hover:text-primary-700 font-medium hover:underline">Sign in</a>
				</p>
			</div>
		</div>
	</div>
